...
world.roads.push(
  ...
  { x:11,y:22,w:3,h:1 },   // central pier apron
  { x:12,y:22,w:1,h:4 },   // central pier
...
function emitNewportMasterplanQA(visualCompositionStatus='PENDING'){
  ...
  const centralPierPresent=hasRoadRect(12,22,1,3);
