...
world.buildings.push(
  placeLotBuilding({ id:"b_boathouse", role:"boathouse_ship_shed_shipwright", spriteId:"newport_dockside_storehouse", x:9,y:18,w:5,h:4,anchorX:3,anchorY:4,district:"harbor_wharf",block:"wharf_w",row:"harbor_edge", lotRect:{x:9,y:18,w:6,h:5},visualLotRect:{x:9,y:18,w:5,h:4},baseFootprint:{x:12,y:21,w:2,h:1},collision:{x:12,y:21,w:2,h:1},interaction:{x:11,y:18,w:1,h:1},frontageTile:{x:11,y:18},frontWalkBand:{x:10,y:18,w:2,h:1},supportedWaterFootprint:[{x:12,y:21},{x:13,y:21}],label:{x:11,y:18,text:"Boathouse"},pathingBounds:{x:9,y:17,w:6,h:7} }),
  placeLotBuilding({ id:"b_dock_storehouse", role:"dockside_storehouse", spriteId:"newport_dockside_storehouse_long", x:29,y:18,w:6,h:4,anchorX:3,anchorY:4,district:"harbor_wharf",block:"wharf_c",row:"harbor_edge", lotRect:{x:29,y:18,w:6,h:5},visualLotRect:{x:29,y:18,w:6,h:4},baseFootprint:{x:32,y:21,w:2,h:1},collision:{x:32,y:21,w:2,h:1},interaction:{x:32,y:18,w:1,h:1},frontageTile:{x:32,y:18},frontWalkBand:{x:31,y:18,w:2,h:1},supportedWaterFootprint:[{x:32,y:21},{x:33,y:21}],label:{x:32,y:18,text:"Dock Storehouse"},pathingBounds:{x:28,y:17,w:8,h:7} }),
  placeLotBuilding({ id:"b_market_shed", role:"market_shed_harbor_stalls", spriteId:"newport_market_shed_stalls", x:36,y:18,w:4,h:3,anchorX:2,anchorY:4,district:"harbor_wharf",block:"wharf_e",row:"harbor_edge", lotRect:{x:36,y:18,w:5,h:4},visualLotRect:{x:36,y:18,w:4,h:3},baseFootprint:{x:38,y:21,w:1,h:1},collision:{x:38,y:21,w:1,h:1},interaction:{x:32,y:18,w:1,h:1},frontageTile:{x:32,y:18},frontWalkBand:{x:31,y:18,w:2,h:1},supportedWaterFootprint:[{x:38,y:21}],label:{x:37,y:18,text:"Harbor Shed"},pathingBounds:{x:35,y:17,w:6,h:7} }),
  placeLotBuilding({ id:"b_inn_tavern", role:"inn_tavern", spriteId:"inn_tavern_v1", x:8,y:12,w:6,h:5,anchorX:3,anchorY:4,district:"commercial_corridor",block:"waterfront_w",row:"waterfront_frontage", lotRect:{x:8,y:12,w:6,h:5},visualLotRect:{x:8,y:12,w:6,h:5},collision:{x:9,y:16,w:3,h:1},interaction:{x:11,y:18,w:1,h:1},frontageTile:{x:11,y:18},frontWalkBand:{x:9,y:18,w:5,h:1},label:{x:11,y:13,text:"Inn & Tavern"},pathingBounds:{x:7,y:11,w:8,h:8} }),
  placeLotBuilding({ id:"b_mercantile", role:"mercantile_shop", spriteId:"mercantile_shop", x:15,y:8,w:5,h:5,anchorX:2,anchorY:4,district:"commercial_corridor",block:"waterfront_w",row:"waterfront_frontage", lotRect:{x:15,y:8,w:5,h:5},visualLotRect:{x:15,y:8,w:5,h:5},collision:{x:18,y:12,w:1,h:1},interaction:{x:17,y:18,w:1,h:1},frontageTile:{x:17,y:18},frontWalkBand:{x:15,y:18,w:5,h:1},label:{x:17,y:9,text:"Mercantile"},pathingBounds:{x:14,y:7,w:7,h:12} }),
  placeLotBuilding({ id:"b_counting_house", role:"warehouse_counting_house", spriteId:"newport_counting_house_civic_exchange", x:21,y:14,w:6,h:5,anchorX:3,anchorY:4,district:"commercial_corridor",block:"waterfront_c",row:"waterfront_frontage", lotRect:{x:21,y:14,w:6,h:5},visualLotRect:{x:21,y:14,w:6,h:5},collision:{x:22,y:17,w:3,h:1},interaction:{x:24,y:18,w:1,h:1},frontageTile:{x:24,y:18},frontWalkBand:{x:21,y:18,w:6,h:1},label:{x:24,y:15,text:"Counting House"},pathingBounds:{x:20,y:13,w:8,h:7} }),
  placeLotBuilding({ id:"b_chandlery_front", role:"chandlery_outfitter_frontage", spriteId:"newport_chandlery_outfitter_front", x:28,y:12,w:5,h:4,anchorX:3,anchorY:4,district:"commercial_corridor",block:"waterfront_e",row:"waterfront_frontage", lotRect:{x:28,y:12,w:5,h:5},visualLotRect:{x:28,y:12,w:5,h:4},collision:{x:30,y:16,w:2,h:1},interaction:{x:29,y:18,w:1,h:1},frontageTile:{x:29,y:18},frontWalkBand:{x:28,y:18,w:5,h:1},label:{x:30,y:13,text:"Chandlery"},pathingBounds:{x:27,y:11,w:7,h:8} }),
  placeLotBuilding({ id:"b_shop_house", role:"waterfront_mixed_use_shop_house", spriteId:"newport_waterfront_shop_house", x:34,y:13,w:5,h:4,anchorX:2,anchorY:4,district:"commercial_corridor",block:"east_commercial_extension",row:"service_frontage", lotRect:{x:34,y:13,w:5,h:5},visualLotRect:{x:34,y:13,w:5,h:4},collision:{x:35,y:17,w:1,h:1},interaction:{x:37,y:14,w:1,h:1},frontageTile:{x:37,y:14},frontWalkBand:{x:37,y:14,w:2,h:1},label:{x:36,y:14,text:"Shop House"},pathingBounds:{x:33,y:12,w:8,h:8} }),
  ...
  placeLotBuilding({ id:"b_village_hall", role:"village_hall_meeting_house", spriteId:"village_hall_meeting_house", x:20,y:7,w:6,h:5,anchorX:3,anchorY:4,district:"civic_green_axis",block:"meeting_green",row:"civic_axis", lotRect:{x:20,y:7,w:6,h:5},visualLotRect:{x:20,y:7,w:6,h:5},collision:{x:21,y:11,w:4,h:1},interaction:{x:24,y:12,w:1,h:1},frontageTile:{x:24,y:12},frontWalkBand:{x:21,y:12,w:6,h:1},label:{x:23,y:8,text:"Village Hall"},pathingBounds:{x:19,y:6,w:8,h:7} }),
  placeLotBuilding({ id:"b_res_small", role:"residence_small", spriteId:"residence_small", x:4,y:8,w:4,h:4,anchorX:2,anchorY:3,district:"modest_residential_service",block:"west_service_edge",row:"lower_service", lotRect:{x:4,y:8,w:4,h:4},visualLotRect:{x:4,y:8,w:4,h:4},collision:{x:6,y:11,w:1,h:1},interaction:{x:5,y:10,w:1,h:1},frontageTile:{x:5,y:10},frontWalkBand:{x:5,y:10,w:2,h:1},label:{x:6,y:9,text:"Cottage"},pathingBounds:{x:3,y:7,w:6,h:7} }),
  placeLotBuilding({ id:"b_townhouse_row_a", role:"narrow_merchant_townhouse", spriteId:"newport_narrow_merchant_townhouse_a", x:38,y:9,w:3,h:5,anchorX:2,anchorY:4,district:"commercial_corridor",block:"east_commercial_extension",row:"service_frontage", lotRect:{x:38,y:9,w:4,h:5},visualLotRect:{x:38,y:9,w:3,h:5},collision:{x:39,y:13,w:2,h:1},groundSolidFootprint:{x:39,y:13,w:2,h:1},interaction:{x:37,y:14,w:1,h:1},frontageTile:{x:37,y:14},frontWalkBand:{x:37,y:14,w:2,h:1},label:{x:39,y:10,text:"Row A"},pathingBounds:{x:37,y:8,w:7,h:8} }),
  placeLotBuilding({ id:"b_townhouse_row_b", role:"modest_clapboard_residence", spriteId:"newport_modest_clapboard_residence_a", x:37,y:3,w:5,h:4,anchorX:2,anchorY:4,district:"modest_residential_service",block:"east_residential_lane",row:"upper_service", lotRect:{x:37,y:3,w:5,h:4},visualLotRect:{x:37,y:3,w:5,h:4},collision:{x:39,y:7,w:2,h:1},interaction:{x:37,y:10,w:1,h:1},frontageTile:{x:37,y:10},frontWalkBand:{x:37,y:10,w:1,h:1},label:{x:38,y:4,text:"Row B"},pathingBounds:{x:36,y:2,w:7,h:9} }),
  placeLotBuilding({ id:"b_service_dependency", role:"service_outbuilding_dependency", spriteId:"service_dependency_shed", x:39,y:16,w:4,h:3,anchorX:2,anchorY:3,district:"modest_residential_service",block:"east_service_edge",row:"service_lane", lotRect:{x:39,y:16,w:4,h:4},visualLotRect:{x:39,y:16,w:4,h:3},collision:{x:40,y:17,w:1,h:1},interaction:{x:37,y:15,w:1,h:1},frontageTile:{x:37,y:15},frontWalkBand:{x:37,y:15,w:1,h:1},label:{x:40,y:17,text:"Service"},pathingBounds:{x:38,y:15,w:6,h:6} }),
  placeLotBuilding({ id:"b_hunter_lodge", role:"hunter_lodge_or_outfitter", spriteId:"hunter_lodge_or_outfitter", x:4,y:14,w:4,h:4,anchorX:2,anchorY:3,district:"rural_outskirts",districtTag:"rural/outskirts",block:"west_rural_edge",row:"outskirts_lane", lotRect:{x:4,y:14,w:4,h:4},visualLotRect:{x:4,y:14,w:4,h:4},collision:{x:4,y:16,w:1,h:1},interaction:{x:5,y:14,w:1,h:1},frontageTile:{x:5,y:14},frontWalkBand:{x:5,y:14,w:1,h:1},label:{x:6,y:15,text:"Outfitter"},pathingBounds:{x:3,y:13,w:6,h:7} }),
  placeLotBuilding({ id:"b_res_large", role:"residence_large", spriteId:"residence_large", x:11,y:2,w:5,h:4,anchorX:2,anchorY:3,district:"elite_inland_residential",block:"upper_terrace",row:"mansion_w", lotRect:{x:11,y:2,w:5,h:4},visualLotRect:{x:11,y:2,w:5,h:4},collision:{x:12,y:5,w:2,h:1},interaction:{x:13,y:7,w:1,h:1},frontageTile:{x:13,y:7},frontWalkBand:{x:12,y:7,w:3,h:1},label:{x:13,y:3,text:"Large Residence"},pathingBounds:{x:10,y:1,w:7,h:7} }),
  placeLotBuilding({ id:"b_georgian_residence", role:"georgian_merchant_residence", spriteId:"newport_georgian_merchant_residence_a", x:17,y:2,w:5,h:5,anchorX:2,anchorY:4,district:"elite_inland_residential",block:"upper_terrace",row:"mansion_c", lotRect:{x:17,y:2,w:5,h:5},visualLotRect:{x:17,y:2,w:5,h:5},collision:{x:18,y:5,w:2,h:1},interaction:{x:18,y:7,w:1,h:1},frontageTile:{x:18,y:7},frontWalkBand:{x:17,y:7,w:3,h:1},label:{x:18,y:3,text:"Georgian"},pathingBounds:{x:16,y:1,w:7,h:7} }),
  placeLotBuilding({ id:"b_elite_mansion", role:"elite_garden_front_mansion", spriteId:"newport_elite_garden_mansion_a", x:4,y:2,w:5,h:4,anchorX:2,anchorY:3,district:"elite_inland_residential",block:"upper_terrace",row:"mansion_w", lotRect:{x:4,y:2,w:5,h:5},visualLotRect:{x:4,y:2,w:5,h:4},collision:{x:6,y:5,w:2,h:1},interaction:{x:5,y:10,w:1,h:1},frontageTile:{x:5,y:10},frontWalkBand:{x:5,y:10,w:2,h:1},label:{x:6,y:3,text:"Mansion"},pathingBounds:{x:3,y:1,w:7,h:10} }),
  placeLotBuilding({ id:"b_prestige_block", role:"formal_townhouse_block", spriteId:"newport_formal_townhouse_block_a", x:31,y:2,w:5,h:4,anchorX:2,anchorY:4,district:"elite_inland_residential",block:"upland",row:"mansion_n", lotRect:{x:31,y:2,w:5,h:5},visualLotRect:{x:31,y:2,w:5,h:4},collision:{x:32,y:5,w:2,h:1},interaction:{x:33,y:7,w:1,h:1},frontageTile:{x:33,y:7},frontWalkBand:{x:31,y:7,w:5,h:1},label:{x:33,y:3,text:"Prestige Row"},pathingBounds:{x:30,y:1,w:7,h:7} })
);
...
const NEWPORT_TOWN_BLUEPRINT_V2=Object.freeze({
  phase:"35.13Q_newport_historic_placement_depth_order",
  ...
  for(let i=0;i<buildingReports.length;i++){
    for(let j=i+1;j<buildingReports.length;j++){
      ...
      if(area>0.2){
        ...
        if(hiddenRatio>0.08) overlapHiddenPairs.push(pair);
      }
    }
  }
