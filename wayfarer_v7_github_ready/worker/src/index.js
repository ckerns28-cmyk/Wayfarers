...
const WAYFARER_BUILD_LABEL = "Phase 35.9L.6 — Dock Storehouse Pier Regression + Remaining Visual Failures";
const ATLAS_SELECTOR_VERSION = "selector-v35.9l6-dock-storehouse-pier-regression-repair";
...
function logBuildingSourceOfTruthAudit(){
  ...
  const proofHudConsistent=WAYFARER_PHASE==='35.9L' && ATLAS_SELECTOR_VERSION==='selector-v35.9l6-dock-storehouse-pier-regression-repair';
  const previewModeActive=Boolean(SECONDARY_ATLAS_RUNTIME_PREVIEW_TARGET?.resolvedBuildingId);
...
function buildWayfarerQaReport(){
  ...
  const buildPhaseMatches=WAYFARER_PHASE==="35.9L" && ATLAS_SELECTOR_VERSION==="selector-v35.9l6-dock-storehouse-pier-regression-repair";
