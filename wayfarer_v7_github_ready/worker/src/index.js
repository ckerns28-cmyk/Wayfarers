...
const WAYFARER_BUILD_LABEL = "Phase 35.9L.5 — Visual Composition Gate + Building Staging Repair";
const ATLAS_SELECTOR_VERSION = "selector-v35.9l5-visual-composition-gate-staging-repair";
...
function logBuildingSourceOfTruthAudit(){
  ...
  const proofHudConsistent=WAYFARER_PHASE==='35.9L' && ATLAS_SELECTOR_VERSION==='selector-v35.9l5-visual-composition-gate-staging-repair';
  const previewModeActive=Boolean(SECONDARY_ATLAS_RUNTIME_PREVIEW_TARGET?.resolvedBuildingId);
...
world.buildings.push(
  placeLotBuilding({ id:"b_boathouse", role:"boathouse_ship_shed_shipwright", spriteId:"newport_dockside_storehouse", x:11,y:18,w:5,h:4,anchorX:2,anchorY:2,district:"harbor_wharf",block:"wharf_w",row:"waterfront", lotRect:{x:11,y:18,w:6,h:4},visualLotRect:{x:11,y:18,w:5,h:3},collision:{x:11,y:20,w:4,h:1},interaction:{x:15,y:18,w:1,h:1},frontageTile:{x:15,y:18},frontWalkBand:{x:11,y:18,w:5,h:1},supportedWaterFootprint:[{x:11,y:20},{x:12,y:20},{x:13,y:20},{x:14,y:20}],label:{x:13,y:18,text:"Boathouse"},pathingBounds:{x:10,y:17,w:7,h:5} }),
  placeLotBuilding({ id:"b_dock_storehouse", role:"dockside_storehouse", spriteId:"newport_dockside_storehouse_long", x:18,y:19,w:6,h:4,anchorX:3,anchorY:2,district:"harbor_wharf",block:"wharf_c",row:"waterfront", lotRect:{x:18,y:19,w:6,h:4},visualLotRect:{x:18,y:19,w:6,h:3},collision:{x:18,y:20,w:6,h:1},interaction:{x:20,y:19,w:1,h:1},frontageTile:{x:20,y:19},frontWalkBand:{x:18,y:19,w:6,h:1},supportedWaterFootprint:[{x:18,y:20},{x:19,y:20},{x:20,y:20},{x:21,y:20},{x:22,y:20},{x:23,y:20}],label:{x:20,y:19,text:"Dock Storehouse"},pathingBounds:{x:17,y:18,w:8,h:5} }),
  placeLotBuilding({ id:"b_market_shed", role:"market_shed_harbor_stalls", spriteId:"newport_market_shed_stalls", x:26,y:18,w:5,h:3,anchorX:2,anchorY:2,district:"harbor_wharf",block:"wharf_e",row:"waterfront", lotRect:{x:26,y:18,w:6,h:4},visualLotRect:{x:26,y:18,w:5,h:3},collision:{x:26,y:20,w:5,h:1},interaction:{x:28,y:18,w:1,h:1},frontageTile:{x:28,y:18},frontWalkBand:{x:26,y:18,w:5,h:1},supportedWaterFootprint:[{x:26,y:20},{x:27,y:20},{x:28,y:20},{x:29,y:20},{x:30,y:20}],label:{x:28,y:18,text:"Harbor Market Shed"},pathingBounds:{x:25,y:17,w:7,h:5} }),
...
function buildWayfarerQaReport(){
  ...
  const buildPhaseMatches=WAYFARER_PHASE==="35.9L" && ATLAS_SELECTOR_VERSION==="selector-v35.9l5-visual-composition-gate-staging-repair";
