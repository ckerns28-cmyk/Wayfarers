...
func _draw_roads() -> void:
	...
	var plaza := Rect2i(18, 9, 12, 6)
	for segment in road_segments:
		_draw_tiled_rect(segment, Color("#a9926a"), Color("#857355"), Color(0, 0, 0, 0.07))
	_draw_tiled_rect(plaza, Color("#9a9a85"), Color("#777b6f"), Color(0, 0, 0, 0.07))
	for segment in road_segments:
		_draw_tile_rect_outline(segment, Color(0, 0, 0, 0.13), 2.0)
	_draw_tile_rect_outline(plaza, Color(0, 0, 0, 0.13), 2.0)
...
func _draw_wharf_water() -> void:
	...
	draw_line(Vector2(0, 22 * TILE), Vector2(MAP_W * TILE, 22 * TILE), Color(0.05, 0.12, 0.13, 0.32), 3.0)
