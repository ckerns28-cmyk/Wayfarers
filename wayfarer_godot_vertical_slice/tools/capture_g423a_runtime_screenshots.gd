...
const OUT_DIR := "res://artifacts/review/g423a_runtime_screenshots"
const MANIFEST_FILENAME := "g423a_runtime_screenshot_manifest.json"
...
const CAPTURES := [
	{
		"filename": "g423a_01_whole_town.png",
		"label": "whole town / harborfront avenue, uphill roads, back street, wharf loop",
		"target": "whole_town",
		"player_position": Vector2(800.0, 552.0),
		"camera_zoom": Vector2(1.12, 1.12),
		"camera_offset": Vector2(0.0, -36.0),
	},
	{
		"filename": "g423a_02_harborfront_avenue.png",
		"label": "harborfront avenue / continuous road parallel to harbor work",
		"target": "harborfront_avenue",
		"player_position": Vector2(675.0, 600.0),
		"camera_zoom": Vector2(1.42, 1.42),
		"camera_offset": Vector2(52.0, -56.0),
	},
	{
		"filename": "g423a_03_uphill_connector_road.png",
		"label": "uphill connector road / avenue to civic and back street",
		"target": "uphill_connector_road",
		"player_position": Vector2(704.0, 540.0),
		"camera_zoom": Vector2(1.42, 1.42),
		"camera_offset": Vector2(42.0, -64.0),
	},
	{
		"filename": "g423a_04_back_street.png",
		"label": "back street / inland street behind first waterfront road",
		"target": "back_street",
		"player_position": Vector2(704.0, 392.0),
		"camera_zoom": Vector2(1.42, 1.42),
		"camera_offset": Vector2(72.0, 6.0),
	},
	{
		"filename": "g423a_05_tavern_market_anchor.png",
		"label": "Tavern/Inn and market anchor / social and commercial hierarchy",
		"target": "tavern_market_anchor",
		"player_position": Vector2(300.0, 600.0),
		"camera_zoom": Vector2(1.50, 1.50),
		"camera_offset": Vector2(76.0, -66.0),
	},
	{
		"filename": "g423a_06_player_walkability_proof.png",
		"label": "player walkability proof / avenue to civic, wharf, and back street",
		"target": "player_walkability_proof",
		"player_position": Vector2(675.0, 600.0),
		"camera_zoom": Vector2(1.52, 1.52),
		"camera_offset": Vector2(54.0, -58.0),
	},
]
...
func _capture_all() -> int:
	...
	_write_manifest(manifest)
	print("PASS: G-4.23A runtime screenshots -> ", ProjectSettings.globalize_path(OUT_DIR))
	return 0
...
func _base_manifest() -> Dictionary:
	return {
		"schema_id": "wayfarer.g423a.runtime_screenshot_manifest.v1",
		"phase": "G-4.23A",
		"status": "PENDING",
		"created_at": Time.get_datetime_string_from_system(true),
		"command": OS.get_environment("G423A_CAPTURE_COMMAND"),
