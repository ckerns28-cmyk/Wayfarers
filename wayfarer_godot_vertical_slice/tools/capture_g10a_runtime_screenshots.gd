...
func _capture_all() -> int:
	...
	_write_manifest(manifest)
	print("PASS: G-10A runtime screenshots -> ", ProjectSettings.globalize_path(OUT_DIR))
	return 0
...
func _base_manifest() -> Dictionary:
	return {
		"schema_id": "wayfarer.g10a.runtime_screenshot_manifest.v1",
		"phase": "G-10A",
		"status": "PENDING",
		"created_at": Time.get_datetime_string_from_system(true),
		"command": OS.get_environment("G10A_CAPTURE_COMMAND"),
		...
		"quest_state_proof": "Journal state, objective completion, Third Toast tavern whisper, wharf lantern branch, optional rear-gate discovery, Resolve reward, named contact, and the dawn hook are captured in HUD and quest contracts.",
		"warnings": [],
		"screenshots": [],
	}
