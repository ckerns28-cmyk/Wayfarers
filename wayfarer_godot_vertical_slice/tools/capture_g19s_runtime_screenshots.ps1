...
$OutDir = Join-Path $ProjectRoot "artifacts\review\g19s_runtime_screenshots"
...
$args = @(
    ...
    "--log-file", $LogPath,
    "--script", "res://tools/capture_g19s_runtime_screenshots.gd"
)

Write-Host "Running G-19S runtime screenshot capture:"
