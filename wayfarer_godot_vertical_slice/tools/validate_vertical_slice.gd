...
func _validate_scene(main: Node) -> void:
	...
	_expect(BUILD_INFO.BUILD_PHASE == "G-4.9.6", "build_phase_g_4_9_6")
	_expect(BUILD_INFO.BUILD_LABEL == "Godot G-4.9.6 Street Vignette Acceptance Gate", "build_label_g_4_9_6")
