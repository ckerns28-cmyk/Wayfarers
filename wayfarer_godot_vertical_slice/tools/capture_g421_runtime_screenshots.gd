...
const OUT_DIR := "res://artifacts/review/g421_runtime_screenshots"
const MANIFEST_FILENAME := "g421_runtime_screenshot_manifest.json"
...
const CAPTURES := [
	{
		"filename": "g421_01_origin_city_hero_slice_normal_hud.png",
		"label": "Origin city hero slice with normal HUD, player, street, dock, buildings, and G-4.18E props",
		"target": "origin_city_hero_slice_normal_hud",
	...
	{
		"filename": "g421_02_origin_city_hero_slice_no_hud.png",
		"label": "Same hero-slice composition without HUD for clean council world/art review",
		"target": "origin_city_hero_slice_no_hud",
		"player_position": Vector2(940.0, 704.0),
		"camera_zoom": Vector2(1.18, 1.18),
		"camera_offset": Vector2(20.0, 4.0),
		"direction": "left",
	...
	{
		"filename": "g421_03_hero_street_dock_closeup.png",
		"label": "Close-up hero street/dock read: storefronts, wharf economy, player scale, and prop cohesion",
		"target": "hero_street_dock_closeup",
	...
	{
		"filename": "g421_04_tavern_to_harbor_homebase_read.png",
		"label": "Tavern/Inn to harbor home-base read with social anchor, avenue, and dock approach",
		"target": "tavern_to_harbor_homebase_read",
		"player_position": Vector2(300.0, 604.0),
		"camera_zoom": Vector2(1.36, 1.36),
		"camera_offset": Vector2(50.0, -48.0),
		"direction": "down",
		"moving": false,
		"frame_index": 0,
		"no_hud": true,
	...
	{
		"filename": "g421_05_player_hud_world_cohesion.png",
		"label": "Player, HUD, buildings, props, and road grammar in one gameplay-facing frame",
		"target": "player_hud_world_cohesion",
	...
	{
		"filename": "g421_06_wide_newport_homebase_readability.png",
		"label": "Wide Newport readability proof: harbor, uphill roads, back street, player, and hero slice context",
		"target": "wide_newport_homebase_readability",
...
func _capture_all() -> int:
	...
	_write_manifest(manifest)
	print("PASS: G-4.21 runtime screenshots -> ", ProjectSettings.globalize_path(OUT_DIR))
	return 0
...
func _base_manifest() -> Dictionary:
	return {
		"schema_id": "wayfarer.g421.runtime_screenshot_manifest.v1",
		"phase": "G-4.21",
		"status": "PENDING",
		"created_at": Time.get_datetime_string_from_system(true),
		"command": OS.get_environment("G421_CAPTURE_COMMAND"),
		...
		"required_views": [
			"origin_city_hero_slice_normal_hud",
			"origin_city_hero_slice_no_hud",
			"hero_street_dock_closeup",
			"tavern_to_harbor_homebase_read",
			"player_hud_world_cohesion",
			"wide_newport_homebase_readability",
		],
		"warnings": [],
		"screenshots": [],
	}
