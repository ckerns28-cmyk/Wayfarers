...
const OUT_DIR := "res://artifacts/review/g422a_runtime_screenshots"
const MANIFEST_FILENAME := "g422a_runtime_screenshot_manifest.json"
...
const CAPTURES := [
	{
		"filename": "g422a_01_whole_town.png",
		"label": "whole town / harbor avenue, uphill roads, civic square, wharf loop",
		"target": "whole_town",
		"player_position": Vector2(800.0, 575.0),
		"camera_zoom": Vector2(0.70, 0.70),
		"camera_offset": Vector2(0.0, -28.0),
	},
	{
		"filename": "g422a_02_tavern_market_anchor.png",
		"label": "Tavern/Inn and market avenue anchor",
		"target": "tavern_market_anchor",
		"player_position": Vector2(300.0, 600.0),
		"camera_zoom": Vector2(1.05, 1.05),
		"camera_offset": Vector2(120.0, -62.0),
	},
	{
		"filename": "g422a_03_harbor_loop.png",
		"label": "harbor loop / docks, cargo, warehouse frontage",
		"target": "harbor_loop",
	...
	{
		"filename": "g422a_04_civic_residential_loop.png",
		"label": "civic and residential loop / Town Hall, Customs, homes",
		"target": "civic_residential_loop",
		"player_position": Vector2(704.0, 392.0),
		"camera_zoom": Vector2(0.98, 0.98),
		"camera_offset": Vector2(120.0, -36.0),
	},
	{
		"filename": "g422a_05_backstreet_service_route.png",
		"label": "backstreet and service route / uphill roads and alleys",
		"target": "backstreet_service_route",
		"player_position": Vector2(512.0, 646.0),
		"camera_zoom": Vector2(1.02, 1.02),
		"camera_offset": Vector2(150.0, -110.0),
	},
	{
		"filename": "g422a_06_player_walkability_proof.png",
		"label": "player walkability proof / avenue to civic and wharf routes",
		"target": "player_walkability_proof",
		"player_position": Vector2(675.0, 600.0),
		"camera_zoom": Vector2(0.90, 0.90),
		"camera_offset": Vector2(120.0, -50.0),
	},
]
...
func _capture_all() -> int:
	...
	_write_manifest(manifest)
	print("PASS: G-4.22A runtime screenshots -> ", ProjectSettings.globalize_path(OUT_DIR))
	return 0
...
func _base_manifest() -> Dictionary:
	return {
		"schema_id": "wayfarer.g422a.runtime_screenshot_manifest.v1",
		"phase": "G-4.22A",
		"status": "PENDING",
		"created_at": Time.get_datetime_string_from_system(true),
		"command": OS.get_environment("G422A_CAPTURE_COMMAND"),
