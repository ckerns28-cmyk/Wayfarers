...
$OutDir = Join-Path $ProjectRoot "artifacts\review\g16_runtime_screenshots"
...
$args = @(
    ...
    "--log-file", $LogPath,
    "--script", "res://tools/capture_g16_runtime_screenshots.gd"
)

Write-Host "Running G-16 runtime screenshot capture:"
