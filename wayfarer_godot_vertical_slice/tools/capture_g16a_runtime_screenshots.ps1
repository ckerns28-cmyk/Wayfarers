...
$OutDir = Join-Path $ProjectRoot "artifacts\review\g16a_runtime_screenshots"
...
$args = @(
    ...
    "--log-file", $LogPath,
    "--script", "res://tools/capture_g16a_runtime_screenshots.gd"
)

Write-Host "Running G-16A runtime screenshot capture:"
