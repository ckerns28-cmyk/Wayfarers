...
const OUT_DIR := "res://artifacts/review/g16_runtime_screenshots"
const MANIFEST_FILENAME := "g16_runtime_screenshot_manifest.json"
...
const CAPTURES := [
	{
		"filename": "g16_01_signal_overlook_landmark.png",
		"label": "signal overlook landmark / high-side destination and harbor memory point",
		"target": "signal_overlook",
		"player_position": Vector2(2150.0, 420.0),
		"camera_zoom": Vector2(1.06, 1.06),
		"camera_offset": Vector2(-178.0, 18.0),
		"player_direction": "right",
		"player_moving": false,
		"player_frame": 0
	},
	{
		"filename": "g16_02_old_road_marker_and_grove.png",
		"label": "old road marker and grove / route fork and natural privacy beat are recognizable",
		"target": "old_road_marker_and_grove",
		"player_position": Vector2(2088.0, 504.0),
		"camera_zoom": Vector2(1.16, 1.16),
		"camera_offset": Vector2(-170.0, -72.0),
		"player_direction": "right",
		"player_moving": true,
		"player_frame": 2
	},
	{
		"filename": "g16_03_cove_hidden_landing.png",
		"label": "cove hidden landing / lower island coast has a memorable wharf remnant",
		"target": "cove_hidden_landing",
		"player_position": Vector2(2220.0, 714.0),
		"camera_zoom": Vector2(1.16, 1.16),
		"camera_offset": Vector2(-292.0, -102.0),
		"player_direction": "down",
		"player_moving": false,
		"player_frame": 0
	},
	{
		"filename": "g16_04_farm_service_edge_settlement.png",
		"label": "farm service edge settlement / island is inhabited beyond the village",
		"target": "farm_service_edge_settlement",
		"player_position": Vector2(1886.0, 572.0),
		"camera_zoom": Vector2(1.20, 1.20),
		"camera_offset": Vector2(-132.0, -58.0),
		"player_direction": "right",
		"player_moving": true,
		"player_frame": 1
	},
	{
		"filename": "g16_05_quest_clue_optional_secret.png",
		"label": "quest clue and optional secret / island supports purpose and curiosity",
		"target": "quest_clue_optional_secret",
		"player_position": Vector2(2208.0, 642.0),
		"camera_zoom": Vector2(1.08, 1.08),
		"camera_offset": Vector2(-284.0, -144.0),
		"player_direction": "up",
		"player_moving": false,
		"player_frame": 0
	},
	{
		"filename": "g16_06_return_landmark_debug_disabled.png",
		"label": "return landmark and debug disabled / loop remains oriented back to Newport",
		"target": "return_landmark_debug_disabled",
		"player_position": Vector2(1780.0, 642.0),
		"camera_zoom": Vector2(1.12, 1.12),
		"camera_offset": Vector2(-72.0, -60.0),
...
func _capture_all() -> int:
	...
	_write_manifest(manifest)
	print("PASS: G-16 runtime screenshots -> ", ProjectSettings.globalize_path(OUT_DIR))
	return 0
...
func _base_manifest() -> Dictionary:
	return {
		"schema_id": "wayfarer.g16.runtime_screenshot_manifest.v1",
		"phase": "G-16",
		"out_dir": OUT_DIR,
