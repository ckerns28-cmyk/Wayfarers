...
func _capture_all() -> int:
	...
	_write_manifest(manifest)
	print("PASS: G-9A runtime screenshots -> ", ProjectSettings.globalize_path(OUT_DIR))
	return 0
...
func _base_manifest() -> Dictionary:
	return {
		"schema_id": "wayfarer.g9a.runtime_screenshot_manifest.v1",
		"phase": "G-9A",
		"status": "PENDING",
		"created_at": Time.get_datetime_string_from_system(true),
		"command": OS.get_environment("g9a_CAPTURE_COMMAND"),
		...
		"quest_state_proof": "Journal state, objective completion, objective update feedback, tavern whisper progression, and Resolve reward are captured in HUD and quest contracts.",
		"warnings": [],
		"screenshots": [],
	}
