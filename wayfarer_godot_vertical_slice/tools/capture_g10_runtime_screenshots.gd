...
func _capture_all() -> int:
	...
	_write_manifest(manifest)
	print("PASS: G-10 runtime screenshots -> ", ProjectSettings.globalize_path(OUT_DIR))
	return 0
...
func _base_manifest() -> Dictionary:
	return {
		"schema_id": "wayfarer.g10.runtime_screenshot_manifest.v1",
		"phase": "G-10",
		"status": "PENDING",
		"created_at": Time.get_datetime_string_from_system(true),
		"command": OS.get_environment("G10_CAPTURE_COMMAND"),
