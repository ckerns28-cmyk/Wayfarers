...
const OUT_DIR := "res://artifacts/review/g7a_runtime_screenshots"
const MANIFEST_FILENAME := "g7a_runtime_screenshot_manifest.json"
...
const CAPTURES := [
	{
		"filename": "g7a_01_wide_newport_normal_gameplay_view.png",
		"label": "wide Newport normal gameplay view / cohesive harborfront, back street, and uphill connectors",
		"target": "wide_newport_normal_gameplay_view",
		"player_position": Vector2(800.0, 512.0),
		"camera_zoom": Vector2(1.0, 1.0),
		"camera_offset": Vector2(0.0, 0.0),
	},
	{
		"filename": "g7a_02_player_arrival_at_harbor.png",
		"label": "player arrival at harbor / landfall reads as wharf edge rather than isolated dock patches",
		"target": "player_arrival_at_harbor",
		"player_position": Vector2(805.0, 710.0),
		"camera_zoom": Vector2(1.32, 1.32),
		"camera_offset": Vector2(12.0, 10.0),
	},
	{
		"filename": "g7a_03_route_to_counting_house.png",
		"label": "route to counting house / central uphill connector joins harbor avenue to civic lot",
		"target": "route_to_counting_house",
		"player_position": Vector2(704.0, 520.0),
		"camera_zoom": Vector2(1.36, 1.36),
		"camera_offset": Vector2(38.0, -66.0),
	},
	{
		"filename": "g7a_04_player_near_tavern_inn.png",
		"label": "player near Tavern/Inn / west lot foundation and avenue threshold",
		"target": "player_near_tavern_inn",
		"player_position": Vector2(300.0, 604.0),
		"camera_zoom": Vector2(1.44, 1.44),
		"camera_offset": Vector2(50.0, -58.0),
	},
	{
		"filename": "g7a_05_commercial_avenue.png",
		"label": "commercial avenue / lot foundations and continuous waterfront route",
		"target": "commercial_avenue",
		"player_position": Vector2(850.0, 608.0),
		"camera_zoom": Vector2(1.30, 1.30),
		"camera_offset": Vector2(20.0, -38.0),
	},
	{
		"filename": "g7a_06_dock_wharf_work_area.png",
		"label": "dock and wharf work area / dock-to-road transition and wharf lot foundations",
		"target": "dock_wharf_work_area",
		"player_position": Vector2(1030.0, 704.0),
		"camera_zoom": Vector2(1.34, 1.34),
		"camera_offset": Vector2(20.0, -6.0),
	},
	{
		"filename": "g7a_07_npc_movement_path_area.png",
		"label": "NPC movement path area / sensible harbor route reserved for G-8 animation foundation",
		"target": "npc_movement_path_area",
		"player_position": Vector2(420.0, 690.0),
		"camera_zoom": Vector2(1.42, 1.42),
		"camera_offset": Vector2(32.0, -22.0),
	},
	{
		"filename": "g7a_08_npc_idle_and_walking_proof_area.png",
		"label": "NPC idle and walking proof area / route ground is now coherent; motion quality remains G-8",
		"target": "npc_idle_and_walking_proof_area",
		"player_position": Vector2(1218.0, 690.0),
		"camera_zoom": Vector2(1.42, 1.42),
		"camera_offset": Vector2(0.0, -20.0),
	},
	{
		"filename": "g7a_09_counting_house_interaction_area.png",
		"label": "counting house interaction area / civic lot and connector route are legible",
		"target": "counting_house_interaction_area",
		"player_position": Vector2(704.0, 392.0),
		"camera_zoom": Vector2(1.42, 1.42),
		"camera_offset": Vector2(24.0, -34.0),
	},
	{
		"filename": "g7a_10_tavern_rumor_location_area.png",
		"label": "tavern rumor location area / social pocket is grounded for future whisper gameplay",
		"target": "tavern_rumor_location_area",
		"player_position": Vector2(342.0, 606.0),
		"camera_zoom": Vector2(1.50, 1.50),
		"camera_offset": Vector2(42.0, -62.0),
	},
	{
		"filename": "g7a_11_objective_route_readability_area.png",
		"label": "objective route readability area / route chain from wharf to civic/tavern remains visible with HUD hidden",
		"target": "objective_route_readability_area",
		"player_position": Vector2(675.0, 600.0),
		"camera_zoom": Vector2(1.44, 1.44),
		"camera_offset": Vector2(42.0, -54.0),
	},
	{
		"filename": "g7a_12_signs_markers_interaction_ux_area.png",
		"label": "signs and interaction UX area / no debug road guides or crude markers visible in normal play",
		"target": "signs_markers_interaction_ux_area",
		"player_position": Vector2(1364.0, 636.0),
		"camera_zoom": Vector2(1.46, 1.46),
		"camera_offset": Vector2(-8.0, -44.0),
	},
	{
		"filename": "g7a_13_y_sort_layering_near_buildings.png",
		"label": "y-sort and layering near buildings / foundations sit under building frontage",
		"target": "y_sort_layering_near_buildings",
		"player_position": Vector2(1018.0, 596.0),
		"camera_zoom": Vector2(1.46, 1.46),
		"camera_offset": Vector2(0.0, -54.0),
	},
	{
		"filename": "g7a_14_debug_overlays_disabled.png",
		"label": "debug overlays disabled / blockout guides and primitive normal-play markers remain hidden",
		"target": "debug_overlays_disabled",
		"player_position": Vector2(800.0, 512.0),
		"camera_zoom": Vector2(1.18, 1.18),
		"camera_offset": Vector2(0.0, -8.0),
	},
	{
		"filename": "g7a_15_provenance_no_new_assets_contact_sheet_area.png",
		"label": "provenance proof / no new raster assets added; runtime uses existing atelier-approved atlases",
		"target": "provenance_no_new_assets_contact_sheet_area",
		"player_position": Vector2(704.0, 654.0),
...
func _capture_all() -> int:
	...
	_write_manifest(manifest)
	print("PASS: G-7A runtime screenshots -> ", ProjectSettings.globalize_path(OUT_DIR))
	return 0
...
func _base_manifest() -> Dictionary:
	return {
		"schema_id": "wayfarer.g7a.runtime_screenshot_manifest.v1",
		"phase": "G-7A",
		"status": "PENDING",
		"created_at": Time.get_datetime_string_from_system(true),
		"command": OS.get_environment("G7A_CAPTURE_COMMAND"),
