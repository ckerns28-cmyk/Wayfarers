...
$OutDir = Join-Path $ProjectRoot "artifacts\review\g17_runtime_screenshots"
...
$args = @(
    ...
    "--log-file", $LogPath,
    "--script", "res://tools/capture_g17_runtime_screenshots.gd"
)

Write-Host "Running G-17 runtime screenshot and motion-proof capture:"
