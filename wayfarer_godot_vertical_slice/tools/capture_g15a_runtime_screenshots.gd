...
const OUT_DIR := "res://artifacts/review/g15a_runtime_screenshots"
const MANIFEST_FILENAME := "g15a_runtime_screenshot_manifest.json"
...
const CAPTURES := [
	{
		"filename": "g15a_01_village_exit_to_island.png",
		"label": "village exit to island / Newport east gate reads as the next route",
		"target": "village_exit_to_island",
		"player_position": Vector2(1608.0, 548.0),
		"camera_zoom": Vector2(1.22, 1.22),
		"camera_offset": Vector2(30.0, -48.0),
		"player_direction": "right",
		"player_moving": true,
		"player_frame": 1
	},
	{
		"filename": "g15a_02_island_entry_transition.png",
		"label": "island entry transition / settlement road becomes outskirt lane",
		"target": "island_entry_transition",
		"player_position": Vector2(1792.0, 492.0),
		"camera_zoom": Vector2(1.20, 1.20),
		"camera_offset": Vector2(-120.0, -58.0),
		"player_direction": "right",
		"player_moving": true,
		"player_frame": 2
	},
	{
		"filename": "g15a_03_first_mystery_beyond_town.png",
		"label": "first mystery beyond town / old-road cache creates pull into the island",
		"target": "first_mystery_beyond_town",
		"player_position": Vector2(2150.0, 420.0),
		"camera_zoom": Vector2(1.22, 1.22),
		"camera_offset": Vector2(0.0, -58.0),
		"player_direction": "right",
		"player_moving": false,
		"player_frame": 0
	},
	{
		"filename": "g15a_04_debug_overlays_disabled.png",
		"label": "debug overlays disabled / transition uses authored props, not layout markers",
		"target": "debug_overlays_disabled",
		"player_position": Vector2(1792.0, 492.0),
		"camera_zoom": Vector2(1.08, 1.08),
		"camera_offset": Vector2(-160.0, -34.0),
		"player_direction": "right",
		"player_moving": false,
		"player_frame": 0
	},
...
func _capture_all() -> int:
	...
	manifest["opening_island_transition_contract"] = _jsonify(main.call("opening_island_transition_contract") if main.has_method("opening_island_transition_contract") else {})
	...
	_write_manifest(manifest)
	print("PASS: G-15A runtime screenshots -> ", ProjectSettings.globalize_path(OUT_DIR))
	return 0
...
func _base_manifest() -> Dictionary:
	return {
		"schema_id": "wayfarer.g15a.runtime_screenshot_manifest.v1",
		"phase": "G-15A",
		"out_dir": OUT_DIR,
