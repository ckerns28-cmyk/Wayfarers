...
const OUT_DIR := "res://artifacts/review/g10b_runtime_screenshots"
const MANIFEST_FILENAME := "g10b_runtime_screenshot_manifest.json"
const VIEWPORT_SIZE := Vector2i(1600, 1000)
const INITIAL_WAIT_FRAMES := 36
const CAPTURE_WAIT_FRAMES := 12

const CAPTURES := [
	{"filename": "g10b_01_wide_newport_normal_gameplay_view.png", "label": "wide Newport normal gameplay view / HUD objective is clear without debug overlays", "target": "wide_newport_normal_gameplay_view", "player_position": Vector2(800.0, 512.0), "camera_zoom": Vector2(1.0, 1.0), "camera_offset": Vector2(0.0, 0.0), "player_direction": "down", "player_moving": false, "player_frame": 0, "target_id": "", "dialogue": ""},
	{"filename": "g10b_02_player_arrival_at_harbor.png", "label": "player arrival at harbor / first objective points toward Counting House and tavern whisper", "target": "player_arrival_at_harbor", "player_position": Vector2(805.0, 710.0), "camera_zoom": Vector2(1.32, 1.32), "camera_offset": Vector2(12.0, 10.0), "player_direction": "up", "player_moving": false, "player_frame": 0, "target_id": "", "dialogue": ""},
	{"filename": "g10b_03_player_on_route_to_counting_house.png", "label": "route to counting house / compact prompt names Edrin without Press E debug copy", "target": "route_to_counting_house", "player_position": Vector2(792.0, 570.0), "camera_zoom": Vector2(1.36, 1.36), "camera_offset": Vector2(38.0, -66.0), "player_direction": "up", "player_moving": true, "player_frame": 1, "target_id": "EdrinVale", "dialogue": ""},
	{"filename": "g10b_04_player_near_tavern_inn.png", "label": "player near Tavern/Inn / compact tavern prompt protects the world view", "target": "player_near_tavern_inn", "player_position": Vector2(244.0, 596.0), "camera_zoom": Vector2(1.50, 1.50), "camera_offset": Vector2(42.0, -62.0), "player_direction": "down", "player_moving": false, "player_frame": 0, "target_id": "b_inn_tavern", "dialogue": ""},
	{"filename": "g10b_05_player_on_commercial_avenue.png", "label": "commercial avenue / Harbor Mercantile uses compact enter prompt", "target": "commercial_avenue", "player_position": Vector2(651.0, 596.0), "camera_zoom": Vector2(1.30, 1.30), "camera_offset": Vector2(20.0, -38.0), "player_direction": "left", "player_moving": true, "player_frame": 1, "target_id": "b_mercantile", "dialogue": ""},
	{"filename": "g10b_06_player_at_dock_wharf_work_area.png", "label": "dock and wharf work area / dock storehouse inspection prompt is readable and not oversized", "target": "dock_wharf_work_area", "player_position": Vector2(1030.0, 704.0), "camera_zoom": Vector2(1.34, 1.34), "camera_offset": Vector2(20.0, -6.0), "player_direction": "right", "player_moving": true, "player_frame": 3, "target_id": "b_dock_storehouse", "dialogue": ""},
	{"filename": "g10b_07_player_near_npc_movement_path.png", "label": "player near NPC movement path / rumor carrier prompt is compact and anchored", "target": "npc_movement_path", "player_position": Vector2(748.0, 394.0), "camera_zoom": Vector2(1.42, 1.42), "camera_offset": Vector2(0.0, -38.0), "player_direction": "right", "player_moving": false, "player_frame": 0, "target_id": "nora_vale_rumor_carrier", "dialogue": ""},
	{"filename": "g10b_08_npc_idle_and_walking_proof.png", "label": "NPC idle and walking proof / no marker replaces the accepted no-glide policy", "target": "npc_idle_and_walking_proof", "player_position": Vector2(302.0, 604.0), "camera_zoom": Vector2(1.52, 1.52), "camera_offset": Vector2(40.0, -60.0), "player_direction": "up", "player_moving": false, "player_frame": 0, "target_id": "bess_armitage_tavern_keeper", "dialogue": ""},
	{"filename": "g10b_09_player_interacting_with_counting_house_clerk.png", "label": "counting house interaction / Edrin starts the missing-line investigation", "target": "counting_house_interaction", "player_position": Vector2(792.0, 570.0), "camera_zoom": Vector2(1.42, 1.42), "camera_offset": Vector2(24.0, -34.0), "player_direction": "up", "player_moving": false, "player_frame": 0, "target_id": "EdrinVale", "dialogue": "Edrin Vale: The missing line is not a mistake. Ask the wharf who handled the cargo, then listen at the Tavern/Inn."},
	{"filename": "g10b_10_player_interacting_at_tavern_rumor_location.png", "label": "tavern rumor interaction / Bess names the Third Toast and opens choice", "target": "tavern_rumor_interaction", "player_position": Vector2(302.0, 604.0), "camera_zoom": Vector2(1.50, 1.50), "camera_offset": Vector2(42.0, -62.0), "player_direction": "down", "player_moving": false, "player_frame": 0, "target_id": "bess_armitage_tavern_keeper", "dialogue": "Bess Armitage: Third Toast, then no names. If the lantern burns twice at the wharf, someone chose a side."},
	{"filename": "g10b_11_quest_prompt_journal_objective_proof.png", "label": "quest prompt and objective proof / Honor proves the merchant-street branch can advance the mystery", "target": "quest_prompt_journal_objective_proof", "player_position": Vector2(675.0, 600.0), "camera_zoom": Vector2(1.44, 1.44), "camera_offset": Vector2(42.0, -54.0), "player_direction": "up", "player_moving": true, "player_frame": 2, "target_id": "honor_finch_merchant_shopkeeper", "dialogue": "Honor Finch: If you ask who bought the silence, ask who could afford it twice."},
	{"filename": "g10b_12_signs_markers_interaction_ux_proof.png", "label": "signs and interaction UX proof / Silas proves the optional rear-gate secret path", "target": "signs_markers_interaction_ux_proof", "player_position": Vector2(800.0, 392.0), "camera_zoom": Vector2(1.46, 1.46), "camera_offset": Vector2(-8.0, -44.0), "player_direction": "left", "player_moving": false, "player_frame": 0, "target_id": "silas_crowe_suspicious_patron", "dialogue": "Silas Crowe: Some messages never cross the tavern floor. Watch the rear gate after the second lantern."},
	{"filename": "g10b_13_y_sort_layering_near_buildings_props.png", "label": "y-sort and layering proof / prompt remains compact near buildings and props", "target": "y_sort_layering_near_buildings_props", "player_position": Vector2(651.0, 596.0), "camera_zoom": Vector2(1.46, 1.46), "camera_offset": Vector2(0.0, -54.0), "player_direction": "down", "player_moving": false, "player_frame": 0, "target_id": "b_mercantile", "dialogue": ""},
	{"filename": "g10b_14_debug_overlays_disabled.png", "label": "debug overlays disabled / no route labels, primitive markers, or debug prompt copy", "target": "debug_overlays_disabled", "player_position": Vector2(800.0, 512.0), "camera_zoom": Vector2(1.18, 1.18), "camera_offset": Vector2(0.0, -8.0), "player_direction": "down", "player_moving": false, "player_frame": 0, "target_id": "", "dialogue": ""},
	{"filename": "g10b_15_contact_sheet_provenance_proof.png", "label": "contact sheet and provenance proof / Edrin becomes the named contact hook to continue", "target": "contact_sheet_provenance_proof", "player_position": Vector2(704.0, 654.0), "camera_zoom": Vector2(1.20, 1.20), "camera_offset": Vector2(0.0, -8.0), "player_direction": "right", "player_moving": true, "player_frame": 1, "target_id": "EdrinVale", "dialogue": "Edrin Vale: Keep the missing line out of official ink until dawn. Come back when the harbor bell changes."},
]
...
func _capture_all() -> int:
	...
	_write_manifest(manifest)
	print("PASS: G-10B runtime screenshots -> ", ProjectSettings.globalize_path(OUT_DIR))
	return 0
...
func _base_manifest() -> Dictionary:
	return {
		"schema_id": "wayfarer.g10b.runtime_screenshot_manifest.v1",
		"phase": "G-10B",
		"status": "PENDING",
		"created_at": Time.get_datetime_string_from_system(true),
		"command": OS.get_environment("g10b_CAPTURE_COMMAND"),
		...
		"quest_state_proof": "Journal state, objective completion, Third Toast tavern whisper, wharf lantern branch, merchant-street branch, optional rear-gate discovery, Resolve reward, named contact, and the dawn hook are captured in HUD, quest, and multi-path choice contracts.",
		"warnings": [],
		"screenshots": [],
	}
