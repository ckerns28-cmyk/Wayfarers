...
static func building_definition(building_id: String) -> Dictionary:
	match building_id:
		...
		"b_mercantile":
			return _definition(building_id, "Mercantile", "atelier_newport_mercantile_store_01", "mercantile", 142.0, Vector2(655.0, 847.0), Vector2(126.0, 20.0), Rect2(Vector2(-66.0, -136.0), Vector2(132.0, 148.0)), Vector2(0.0, 22.0), 116.0, false, ["harborfront_commercial", "commercial", "mercantile", "market_spine"], "G-7A-SV0 scale repair: practical coastal mercantile is enlarged to sit beside the clerk rowhouse as a believable building, not a toy-sized prop.")
		"b_counting_house":
