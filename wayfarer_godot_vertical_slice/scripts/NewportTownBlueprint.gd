...
static func reachability_targets() -> Dictionary:
	if G410_STARTER_HARBOR_TOWN:
		return {
			...
			"mercantile_frontage": Vector2i(19, 18),
			"counting_house_frontage": Vector2i(24, 18),
			"chandlery_frontage": Vector2i(30, 18),
			"east_storefront_frontage": Vector2i(36, 18),
...
static func proof_street_walk_targets() -> Dictionary:
	if G410_STARTER_HARBOR_TOWN:
		return {
			...
			"mercantile_door": Vector2i(19, 18),
			"counting_house_door": Vector2i(24, 18),
			"chandlery_door": Vector2i(30, 18),
...
static func building_specs() -> Array:
	if G410_STARTER_HARBOR_TOWN:
		return [
			...
			_catalog_building("b_mercantile", "harborfront_commercial", "commercial", Vector2(20.13, 17.77), true),
			_catalog_building("b_counting_house", "harborfront_commercial", "commercial", Vector2(25.51, 17.42), true),
			_catalog_building("b_chandlery_front", "harborfront_commercial", "commercial", Vector2(31.37, 17.62), true),
			_catalog_building("b_shop_house", "harborfront_commercial", "commercial", Vector2(36.60, 17.36), true),
			_catalog_building("b_printer_rowhouse", "harborfront_commercial", "rowhouse_printer", Vector2(47.01, 17.58)),
			_catalog_building("b_market_shed", "harborfront_commercial", "market", Vector2(42.29, 17.68)),
			...
			_catalog_building("b_clerk_townhouse", "harborfront_commercial", "rowhouse_clerk_lodging", Vector2(14.79, 17.70)),
...
static func starter_lot_specs() -> Array:
	return [
		...
		_lot("lot_mercantile_anchor", "actual", "harborfront_commercial", "mercantile", Rect2i(18, 13, 5, 5), "b_mercantile"),
		_lot("lot_counting_house_anchor", "actual", "harborfront_commercial", "civic_exchange", Rect2i(24, 12, 7, 6), "b_counting_house"),
		_lot("lot_chandlery_anchor", "actual", "harborfront_commercial", "chandlery", Rect2i(30, 13, 6, 5), "b_chandlery_front"),
		_lot("lot_shop_house_anchor", "actual", "harborfront_commercial", "future_storefront_pattern", Rect2i(36, 13, 5, 5), "b_shop_house"),
		...
		_lot("lot_clerk_townhouse_infill", "actual", "harborfront_commercial", "clerk_lodging", Rect2i(12, 13, 6, 5), "b_clerk_townhouse"),
