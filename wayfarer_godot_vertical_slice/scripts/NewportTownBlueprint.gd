...
static func building_specs() -> Array:
	if G410_STARTER_HARBOR_TOWN:
		return [
			...
			_catalog_building("b_mercantile", "harborfront_commercial", "commercial", Vector2(17.51, 17.77), true),
			_catalog_building("b_counting_house", "harborfront_commercial", "commercial", Vector2(22.88, 17.42), true),
			_catalog_building("b_chandlery_front", "harborfront_commercial", "commercial", Vector2(28.74, 17.62), true),
			_catalog_building("b_shop_house", "harborfront_commercial", "commercial", Vector2(33.98, 17.36), true),
			_catalog_building("b_printer_rowhouse", "harborfront_commercial", "rowhouse_printer", Vector2(44.38, 17.58)),
			_catalog_building("b_market_shed", "harborfront_commercial", "market", Vector2(39.67, 17.68)),
			...
			_catalog_building("b_clerk_townhouse", "harborfront_commercial", "rowhouse_clerk_lodging", Vector2(13.48, 17.70)),
...
static func starter_lot_specs() -> Array:
	return [
		...
		_lot("lot_shop_house_anchor", "actual", "harborfront_commercial", "future_storefront_pattern", Rect2i(33, 13, 5, 5), "b_shop_house"),
		_lot("lot_printer_rowhouse_infill", "actual", "harborfront_commercial", "printer_rowhouse", Rect2i(43, 13, 3, 5), "b_printer_rowhouse"),
		_lot("lot_market_shed_anchor", "actual", "harborfront_commercial", "market_stall", Rect2i(38, 13, 5, 5), "b_market_shed"),
