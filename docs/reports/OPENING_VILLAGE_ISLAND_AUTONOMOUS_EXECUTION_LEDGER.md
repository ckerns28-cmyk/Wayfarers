...
| G-19R | Newport Scale + Street Blockout Source of Truth | `codex/g-19r-newport-scale-street-blockout-source-of-truth` | #489 | PASS | `docs/design/NEWPORT_SCALE_STREET_BLOCKOUT_SOURCE_OF_TRUTH.json`, measured SVG/PNG blockout, scale metrics, district/street/lot/NPC/quest/camera plans, source governance, and G-19R validators. |
