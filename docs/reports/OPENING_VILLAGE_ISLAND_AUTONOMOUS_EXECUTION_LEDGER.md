...
| G-18 | Opening Quest Extension: From Whispers to the Island | `codex/g-18-opening-quest-village-to-island` | #487 open | PASS | `docs/reports/G18_OPENING_QUEST_VILLAGE_TO_ISLAND.md`, `wayfarer_godot_vertical_slice/artifacts/review/g18_runtime_screenshots/g18_runtime_screenshot_manifest.json`, and `wayfarer_godot_vertical_slice/artifacts/review/g18_quest_playthrough/quest_playthrough_state_trace.json` prove Whispers Before Dawn is playable from Newport rumors through island evidence, optional clue, return/report, reward, and next hook. |
