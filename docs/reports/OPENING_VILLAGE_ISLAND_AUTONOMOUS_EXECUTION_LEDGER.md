...
| G-16 | Island Landmark and Point-of-Interest Pass | `codex/g-16-island-poi-landmarks` | pending open PR | PASS | `wayfarer_godot_vertical_slice/data/world_layout/island_poi_landmarks_v1.json`, `docs/reports/G16_ISLAND_LANDMARK_POI_PASS.md`, and `wayfarer_godot_vertical_slice/artifacts/review/g16_runtime_screenshots/g16_runtime_screenshot_manifest.json` prove the signal overlook, old road marker, cove hidden landing, wooded grove, service edge, quest clue site, optional secret location, return landmark, and no-HUD/no-debug POI proof. |
