...
| G-15A | Village-to-Island Transition Pass | `codex/g-15a-village-island-transition` | pending open PR | PASS | `wayfarer_godot_vertical_slice/data/world_layout/village_to_island_transition_v1.json`, `docs/reports/G15A_VILLAGE_TO_ISLAND_TRANSITION_PASS.md`, and `wayfarer_godot_vertical_slice/artifacts/review/g15a_runtime_screenshots/g15a_runtime_screenshot_manifest.json` prove the village exit, island entry threshold, first mystery beyond town, and debug-overlays-disabled transition proof. |
