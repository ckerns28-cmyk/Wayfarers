...
| Production cutover is blocked until G-5 parity evidence exists | high | Deployment/release safety | G-6 follow-up | G-6 keeps the JavaScript Worker as the production route until G-5.1 through G-5.9 parity, save compatibility, hosted validation, visual QA, and rollback rehearsal evidence exists. |
